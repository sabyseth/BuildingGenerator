...
public class TreeGeneration : MonoBehaviour
{
    ...
    public int maxRandomObjects = 15; // Maximum number of random objects to spawn
    ...
    public void FindLand(Vector3 position, GameObject Prefab, bool randomizeTransform, bool scaleByTen)
    {
        ...
        Ray ray = new Ray(position + Vector3.up * 10f, -Vector3.up);        
        RaycastHit hitInfo;
        ...
        {
            Debug.LogWarning($"No land found under position {position}.");
        }
    }
